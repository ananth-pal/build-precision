        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="max-w-3xl mb-16">
            ...
            <div className="space-y-4 text-muted-foreground text-sm leading-relaxed mt-6">
              ...
              <p>
                In 1965 he co-founded Productivity Elements Pvt. Ltd. (PROTEL), one of India's first small-scale machine tool companies, and went on to found Pentagon Machines and Services Pvt. Ltd. as a custom machine-tool manufacturer. He also helped establish SRP Tools Ltd. - Listed company where Ramanathan Palaniappan served as Technical Director as Technical Director, where he coordinated the company's collaboration agreements with Mitsubishi for the manufacture of hobs, broaches, shaping cutters, and shaving cutters. SRP grew under his technical leadership into India's largest gear-cutting-tool company.
              </p>
              <p>
