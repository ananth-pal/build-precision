...
import gearGrinderAsset from "@/assets/technologies/gear-hobbing-machine.png.asset.json";
...
const cards: Card[] = [
  ...
  },
  {
    ...
    images: [asmAlt3.url, asmAlt1.url, asmAlt2.url, asmAlt4.url, asmAlt5.url],
    details: [
