        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-card border border-border rounded-lg p-6">
              <h3 className="text-base font-semibold mb-3">Types of Assemblies</h3>
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              <h3 className="text-base font-semibold mb-3">Batch Sizes and Scale-Up</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <h3 className="text-base font-semibold mb-3">Inspection and Tests</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-card border border-border rounded-lg p-6">
              <h3 className="text-base font-semibold mb-3">Sourcing and Integration</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              <h3 className="text-base font-semibold mb-3">Logistics and Shipment Readiness</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
