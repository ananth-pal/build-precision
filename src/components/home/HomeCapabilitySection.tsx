        ...
        <div className="space-y-8">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <article className="capability-card space-y-3">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                43,200 sq. ft. spread across two plants — 20,000 sq. ft. built-up, balance ready for expansion. CNC horizontal and vertical machining centres, CNC turning, cylindrical and surface grinding. A dedicated gear-cutting division with hobbing, shaving, shaping, broaching and profile testing. Clean-room assembly with automated test rigs. CMM and high-resolution surface metrology in-house.
              </p>
